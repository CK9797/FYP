...
@Component({
  ...
  providers: [InvoiceService, updatePaymentStatusService]
})
export class InvoiceComponent implements OnInit {
  ...
  constructor(public serviceInvoice: InvoiceService,
    private serviceupdatePaymentStatus: updatePaymentStatusService,
    fb: FormBuilder) {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.acme.crmblockchain.Invoice',
  ...
  setId2(id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11){
    this.invoiceid1 = id1;
    this.date1 = id2;
    this.details1 = id3;
    this.price1 = id4;
  ...
  updatepaymentTransaction(pa, pt): Promise<any> {
    let Transaction = {
      $class: 'org.acme.crmblockchain.updatePaymentStatus',
      'iv': 'resource:org.acme.crmblockchain.Invoice#' + this.currentId,
    ...
    return this.serviceupdatePaymentStatus.addTransaction(Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
