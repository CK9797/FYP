...
describe('createProposalComponent', () => {
  ...
  let mockcreateProposalService;
  let mockDataService

  beforeEach(async(() => {

    mockcreateProposalService = sinon.createStubInstance(createProposalService);
    mockcreateProposalService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: createProposalService, useValue: mockcreateProposalService },
