...
describe('createDealComponent', () => {
  ...
  let mockcreateDealService;
  let mockDataService

  beforeEach(async(() => {

    mockcreateDealService = sinon.createStubInstance(createDealService);
    mockcreateDealService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: createDealService, useValue: mockcreateDealService },
