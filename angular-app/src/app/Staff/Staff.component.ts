...
export class StaffComponent implements OnInit {
  ...
  constructor(public serviceStaff: StaffService, fb: FormBuilder) {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.acme.crmblockchain.Staff',
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceStaff.updateParticipant(form.get('staffid').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.staffname) {
        formObject.staffname = result.staffname;
      } else {
        formObject.staffname = null;
      }
